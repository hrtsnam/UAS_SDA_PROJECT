...
2. Buka cmd/powershell di direktori saat ini
3. jalankan command '/setup.ps1' untuk menyiapkan engine
4. jalankan command '/build.ps1' untuk build aplikasi
5. jalankan command '/run.ps1' untuk menjalankan aplikasi

## Our Team
| Nama                         | NIM      |
|------------------------------|----------|
| Ahmad Fuad Mubarak           | 2407506  |
| Fadhil Anwar Ahsani          | 2407136  |
| Harits Nur Allam Muhammad    | 2405350  |
| Siti Masdariah               | 2402934  |
| Virgiano Fadhil              | 2409439  |
